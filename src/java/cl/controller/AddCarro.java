 ...
 * @author roman
 */
@WebServlet(name = "AddCarro", urlPatterns = {"/add.do"})
public class AddCarro extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (carro == null) {//SE CREA LA SESION
            carro = new ArrayList();
        }
        //ACTUALIZAR LA SESION
        carro.add(p);
        request.getSession().setAttribute("carro", carro);
        //ACTUALIZAR STOCK DE LA LISTA
        ...
        getServletContext().setAttribute("listaproducto", lista);
